...
Matrix3d SlipSystem::getBCCB(int& count){
...
void SlipSystem::computeTransfromMatrix(){
    ...
    if(Scenario == 1){
        ...
        y1 << sin(phi)*cos(theta), sin(phi)*sin(theta), cos(theta);
