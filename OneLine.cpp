                                  ...
                                  const int& count)
{
    if (hostObject->getAttri(index) != 0) {
        ...
        double dd = 1e10;
        Object tempObject(attr, count, dd);
                                    ...
                                    const int& count)
{
    ...
    if(count != 0 && hostObject->getKey() == 1 && mobileObject->getKey() == 1){
        // vacancy is not reacting with impurity
        return 0.0;
    }
    
    if(hostObject->getAttri(2) == 1 && mobileObject->getKey() < 0){
        return 0.0;
    }
    if(hostObject->getAttri(2) == 2 && mobileObject->getKey() > 0){
        return 0.0;
    }
